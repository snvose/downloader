...
_STRINGS: dict[str, dict[str, str]] = {
    ...
    "help_intro": {
        "tr": "Bana bir bağlantı gönder, medyayı indirip buraya yükleyeyim.",
        "en": "Send me a link and I'll download the media and upload it here.",
        "ru": "Отправьте мне ссылку — я скачаю медиа и загружу сюда.",
        "de": "Sende mir einen Link, ich lade das Medium herunter und hier hoch.",
        "es": "Envíame un enlace y descargaré el contenido para subirlo aquí.",
        "fr": "Envoyez-moi un lien, je télécharge le média et le publie ici.",
        "ar": "أرسل لي رابطًا وسأنزّل الوسائط وأرفعها هنا.",
    },
    "help_group_video": {
        "tr": "🎬 Video & sosyal medya",
        "en": "🎬 Video & social media",
        "ru": "🎬 Видео и соцсети",
        "de": "🎬 Video & soziale Medien",
        "es": "🎬 Vídeo y redes sociales",
        "fr": "🎬 Vidéo et réseaux sociaux",
        "ar": "🎬 الفيديو ووسائل التواصل",
    },
    "help_group_audio": {
        "tr": "🎵 Müzik & ses",
        "en": "🎵 Music & audio",
    ...
    "help_feat_quality": {
        "tr": "YouTube'da kalite seçimi (1080p'ye kadar)",
        "en": "Quality selection on YouTube (up to 1080p)",
        "ru": "Выбор качества на YouTube (до 1080p)",
        "de": "Qualitätsauswahl bei YouTube (bis 1080p)",
        "es": "Selección de calidad en YouTube (hasta 1080p)",
        "fr": "Choix de la qualité sur YouTube (jusqu'à 1080p)",
        "ar": "اختيار الجودة على يوتيوب (حتى 1080p)",
    },
    "help_feat_audio": {
        "tr": "Ses olarak indirme (320k'ya kadar, kapak ve etiketlerle)",
        "en": "Audio download (up to 320k, with cover art and tags)",
        "ru": "Скачивание аудио (до 320k, с обложкой и тегами)",
        "de": "Audio-Download (bis 320k, mit Cover und Tags)",
        "es": "Descarga de audio (hasta 320k, con carátula y etiquetas)",
        "fr": "Téléchargement audio (jusqu'à 320k, avec pochette et tags)",
        "ar": "تنزيل صوتي (حتى 320k، مع الغلاف والوسوم)",
    },
    "help_feat_subtitle": {
        "tr": "YouTube videolarına gömülü altyazı (TR / EN)",
        "en": "Embedded subtitles on YouTube videos (TR / EN)",
        "ru": "Встроенные субтитры для видео YouTube (TR / EN)",
        "de": "Eingebettete Untertitel bei YouTube-Videos (TR / EN)",
        "es": "Subtítulos incrustados en vídeos de YouTube (TR / EN)",
        "fr": "Sous-titres intégrés aux vidéos YouTube (TR / EN)",
        "ar": "ترجمات مدمجة في فيديوهات يوتيوب (TR / EN)",
    },
    "help_feat_playlist": {
        "tr": "YouTube playlist'lerinden seçmeli indirme (özelden)",
        "en": "Selective download from YouTube playlists (in private chat)",
        "ru": "Выборочная загрузка из плейлистов YouTube (в личных сообщениях)",
        "de": "Selektiver Download aus YouTube-Playlists (im Privatchat)",
        "es": "Descarga selectiva de listas de YouTube (en chat privado)",
        "fr": "Téléchargement sélectif depuis les playlists YouTube (en privé)",
        "ar": "تنزيل انتقائي من قوائم يوتيوب (في المحادثة الخاصة)",
    },
    "help_duyurular": {
